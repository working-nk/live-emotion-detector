Live Emotion Detection (LDE), is used to detect emotions shown by humans on their face in real time. Using the concept of Deep Learning, a neural network more 
specifically a convolution neural network is trained using data of large number of images, which is used to predict emotions. This data contains different images 
of faces showing various emotions. Convolution neural network train from these images and a model is prepared. To feed live image to this model, so that model 
